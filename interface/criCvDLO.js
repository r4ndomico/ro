...
(function() {
if (dwr.engine._getObject("criCvDLO") == undefined) {
var p;
...
return dwr.engine._execute(p._path, 'criCvDLO', 'findByCipVisita', arguments);
};
...
return dwr.engine._execute(p._path, 'criCvDLO', 'obterPorCipVisita', arguments);
};
...
return dwr.engine._execute(p._path, 'criCvDLO', 'obterCriticasConvenioNfa', arguments);
};
...
p.obterCriticaConvenioVigente = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'criCvDLO', 'obterCriticaConvenioVigente', arguments);
};
...
p.obterCriticaConvenioVigente = function(p0, callback) {
return dwr.engine._execute(p._path, 'criCvDLO', 'obterCriticaConvenioVigente', arguments);
};
...
return dwr.engine._execute(p._path, 'criCvDLO', 'findTipoMatMedByCipVisita', arguments);
};

dwr.engine._setObject("criCvDLO", p);
}
})();
