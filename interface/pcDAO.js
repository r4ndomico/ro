...
(function() {
if (dwr.engine._getObject("pcDAO") == undefined) {
var p;
...
return dwr.engine._execute(p._path, 'pcDAO', 'getInstance', arguments);
};
...
return dwr.engine._execute(p._path, 'pcDAO', 'findByCodigo', arguments);
};
...
p.findByEmpresaAndExameAndNotExistsInExaNpc = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'pcDAO', 'findByEmpresaAndExameAndNotExistsInExaNpc', arguments);
};
...
p.atualizarCodigoSap = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'pcDAO', 'atualizarCodigoSap', arguments);
};
...
p.exigeNomeMae = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'pcDAO', 'exigeNomeMae', arguments);
};
...
p.permiteEnvioSms = function(p0, callback) {
return dwr.engine._execute(p._path, 'pcDAO', 'permiteEnvioSms', arguments);
};
...
p.buscaHoraMinAlertaUrgente = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'pcDAO', 'buscaHoraMinAlertaUrgente', arguments);
};
...
p.buscaHoraMinAlertaUrgente = function(p0, callback) {
return dwr.engine._execute(p._path, 'pcDAO', 'buscaHoraMinAlertaUrgente', arguments);
};
...
p.enviaDesblFilaColeta = function(p0, callback) {
return dwr.engine._execute(p._path, 'pcDAO', 'enviaDesblFilaColeta', arguments);
};
...
p.BusacaMetasPorMnemonicoPc = function(p0, callback) {
return dwr.engine._execute(p._path, 'pcDAO', 'BusacaMetasPorMnemonicoPc', arguments);
};
...
p.BusacaMetasPorMnemonicoPc = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'pcDAO', 'BusacaMetasPorMnemonicoPc', arguments);
};
...
p.findCompletoByMnemonico = function(p0, callback) {
return dwr.engine._execute(p._path, 'pcDAO', 'findCompletoByMnemonico', arguments);
};
...
p.buscaTipoUnidade = function(p0, callback) {
return dwr.engine._execute(p._path, 'pcDAO', 'buscaTipoUnidade', arguments);
};
...
p.buscaTipoUnidade = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'pcDAO', 'buscaTipoUnidade', arguments);
};
...
p.findUtilizaMotionByCodigo = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'pcDAO', 'findUtilizaMotionByCodigo', arguments);
};
...
p.obterUnidadesPorCNPJ = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'pcDAO', 'obterUnidadesPorCNPJ', arguments);
};
...
p.obterMnmPorCNPJ = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'pcDAO', 'obterMnmPorCNPJ', arguments);
};
...
p.obterMnmPorCNPJ = function(p0, callback) {
return dwr.engine._execute(p._path, 'pcDAO', 'obterMnmPorCNPJ', arguments);
};
...
p.recuperaLocaisAtendimento = function(p0, callback) {
return dwr.engine._execute(p._path, 'pcDAO', 'recuperaLocaisAtendimento', arguments);
};
...
p.findCodigoNumerico = function(p0, callback) {
return dwr.engine._execute(p._path, 'pcDAO', 'findCodigoNumerico', arguments);
};
...
p.obterTimeZone = function(p0, callback) {
return dwr.engine._execute(p._path, 'pcDAO', 'obterTimeZone', arguments);
};
...
p.ehImprimiEtiquetaProtRdiRec = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'pcDAO', 'ehImprimiEtiquetaProtRdiRec', arguments);
};
...
return dwr.engine._execute(p._path, 'pcDAO', 'findByRecipiente', arguments);
};

dwr.engine._setObject("pcDAO", p);
}
})();
