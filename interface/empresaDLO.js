...
(function() {
if (dwr.engine._getObject("empresaDLO") == undefined) {
var p;
...
p.obterEmpresaPorCodigo = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'empresaDLO', 'obterEmpresaPorCodigo', arguments);
};
...
p.obterEmpresaPorCodigo = function(p0, callback) {
return dwr.engine._execute(p._path, 'empresaDLO', 'obterEmpresaPorCodigo', arguments);
};
...
return dwr.engine._execute(p._path, 'empresaDLO', 'findAll', arguments);
};
...
return dwr.engine._execute(p._path, 'empresaDLO', 'obterPorMnmUnidade', arguments);
};
...
return dwr.engine._execute(p._path, 'empresaDLO', 'obterCodigoFilaAtend', arguments);
};

dwr.engine._setObject("empresaDLO", p);
}
})();
