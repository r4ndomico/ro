...
(function() {
if (dwr.engine._getObject("pacienteDLO") == undefined) {
var p;
...
return dwr.engine._execute(p._path, 'pacienteDLO', 'getInstance', arguments);
};
...
return dwr.engine._execute(p._path, 'pacienteDLO', 'getCpf', arguments);
};
...
return dwr.engine._execute(p._path, 'pacienteDLO', 'obterFotoPorCip', arguments);
};
...
return dwr.engine._execute(p._path, 'pacienteDLO', 'manterFotoPorCip', arguments);
};
...
p.obterPorCip = function(p0, callback) {
return dwr.engine._execute(p._path, 'pacienteDLO', 'obterPorCip', arguments);
};
...
p.obterPorCip = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'pacienteDLO', 'obterPorCip', arguments);
};
...
p.findByCipNova = function(p0, callback) {
return dwr.engine._execute(p._path, 'pacienteDLO', 'findByCipNova', arguments);
};
...
p.registrarPacienteSemCPF = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'pacienteDLO', 'registrarPacienteSemCPF', arguments);
};
...
return dwr.engine._execute(p._path, 'pacienteDLO', 'atualizarPacGenero', arguments);
};
...
p.gerarUrlIframeBiometriaUnimed = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'pacienteDLO', 'gerarUrlIframeBiometriaUnimed', arguments);
};
...
p.isVip = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'pacienteDLO', 'isVip', arguments);
};
...
return dwr.engine._execute(p._path, 'pacienteDLO', 'obterPacientesPorNomeFonetizadoDtNascSexoLista', arguments);
};
...
return dwr.engine._execute(p._path, 'pacienteDLO', 'obterPacientesPorNomeFonetizadoDtNascLista', arguments);
};
...
return dwr.engine._execute(p._path, 'pacienteDLO', 'obterPacientesPorNomeFonetizadoDtNascSexo', arguments);
};
...
return dwr.engine._execute(p._path, 'pacienteDLO', 'listarDataNascPorNome', arguments);
};
...
p.listarCipPorNomeDataNasc = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'pacienteDLO', 'listarCipPorNomeDataNasc', arguments);
};
...
return dwr.engine._execute(p._path, 'pacienteDLO', 'listarCipPorCpf', arguments);
};
...
p.getNomeByCip = function(p0, callback) {
return dwr.engine._execute(p._path, 'pacienteDLO', 'getNomeByCip', arguments);
};
...
p.cadastraAtualizaPaciente = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'pacienteDLO', 'cadastraAtualizaPaciente', arguments);
};
...
p.findResumoByMatric = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'pacienteDLO', 'findResumoByMatric', arguments);
};
...
p.recuperaPacPorRec = function(p0, callback) {
return dwr.engine._execute(p._path, 'pacienteDLO', 'recuperaPacPorRec', arguments);
};
...
p.obterNovoPaciente = function(p0, callback) {
return dwr.engine._execute(p._path, 'pacienteDLO', 'obterNovoPaciente', arguments);
};
...
p.cadastrarPaciente = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'pacienteDLO', 'cadastrarPaciente', arguments);
};
...
return dwr.engine._execute(p._path, 'pacienteDLO', 'validaCip', arguments);
};
...
p.buscarDadosGuia = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'pacienteDLO', 'buscarDadosGuia', arguments);
};
...
p.obterCipPacientePorNomeDtNascSexo = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'pacienteDLO', 'obterCipPacientePorNomeDtNascSexo', arguments);
};
...
p.obterPacientePorNomeDataNascimento = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'pacienteDLO', 'obterPacientePorNomeDataNascimento', arguments);
};
...
return dwr.engine._execute(p._path, 'pacienteDLO', 'obterPorCarteirinha', arguments);
};

dwr.engine._setObject("pacienteDLO", p);
}
})();
