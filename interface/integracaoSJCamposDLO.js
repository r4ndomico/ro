...
(function() {
if (dwr.engine._getObject("integracaoSJCamposDLO") == undefined) {
var p;
...
return dwr.engine._execute(p._path, 'integracaoSJCamposDLO', 'getInstance', arguments);
};
...
p.buscarExamesPorCodigoExternoSUS = function(p0, callback) {
return dwr.engine._execute(p._path, 'integracaoSJCamposDLO', 'buscarExamesPorCodigoExternoSUS', arguments);
};
...
p.buscarDadosGuiaDoProtocolo = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'integracaoSJCamposDLO', 'buscarDadosGuiaDoProtocolo', arguments);
};

dwr.engine._setObject("integracaoSJCamposDLO", p);
}
})();
