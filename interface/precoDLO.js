...
(function() {
if (dwr.engine._getObject("precoDLO") == undefined) {
var p;
...
p.valorVisita = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'precoDLO', 'valorVisita', arguments);
};
...
p.precoExame = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'precoDLO', 'precoExame', arguments);
};
...
p.obterHitoricoPrecoExame = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'precoDLO', 'obterHitoricoPrecoExame', arguments);
};
...
p.excluirExame = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'precoDLO', 'excluirExame', arguments);
};
...
p.excluirTodos = function(p0, callback) {
return dwr.engine._execute(p._path, 'precoDLO', 'excluirTodos', arguments);
};
...
p.totalExame = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'precoDLO', 'totalExame', arguments);
};
...
p.precoExameRel = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'precoDLO', 'precoExameRel', arguments);
};
...
p.precoConvExaTodos = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'precoDLO', 'precoConvExaTodos', arguments);
};

dwr.engine._setObject("precoDLO", p);
}
})();
