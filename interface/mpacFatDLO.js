...
(function() {
if (dwr.engine._getObject("mpacFatDLO") == undefined) {
var p;
...
p.atualizarDataOperacaoPorCipVisitaSeq = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'mpacFatDLO', 'atualizarDataOperacaoPorCipVisitaSeq', arguments);
};

dwr.engine._setObject("mpacFatDLO", p);
}
})();
