...
(function() {
if (dwr.engine._getObject("metExaDLO") == undefined) {
var p;
...
p.obterMetExaDescricaoPorExame = function(p0, callback) {
return dwr.engine._execute(p._path, 'metExaDLO', 'obterMetExaDescricaoPorExame', arguments);
};

dwr.engine._setObject("metExaDLO", p);
}
})();
