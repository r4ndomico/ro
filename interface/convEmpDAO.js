...
(function() {
if (dwr.engine._getObject("convEmpDAO") == undefined) {
var p;
...
p.findCodEmp = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'convEmpDAO', 'findCodEmp', arguments);
};

dwr.engine._setObject("convEmpDAO", p);
}
})();
