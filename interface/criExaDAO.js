...
(function() {
if (dwr.engine._getObject("criExaDAO") == undefined) {
var p;
...
p.unidadesQueRealizamExamePeloExame = function(p0, callback) {
return dwr.engine._execute(p._path, 'criExaDAO', 'unidadesQueRealizamExamePeloExame', arguments);
};
...
p.findByAdmitidos = function(p0, callback) {
return dwr.engine._execute(p._path, 'criExaDAO', 'findByAdmitidos', arguments);
};
...
p.unidadesQueRealizamExame = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'criExaDAO', 'unidadesQueRealizamExame', arguments);
};
...
p.buscaExamePai = function(p0, callback) {
return dwr.engine._execute(p._path, 'criExaDAO', 'buscaExamePai', arguments);
};
...
p.obterCriExaPorExameDtRef = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'criExaDAO', 'obterCriExaPorExameDtRef', arguments);
};
...
return dwr.engine._execute(p._path, 'criExaDAO', 'isExameAdministraDrogasTerapeuticas', arguments);
};
...
return dwr.engine._execute(p._path, 'criExaDAO', 'findByMnemonico', arguments);
};
...
dwr.engine._setObject("criExaDAO", p);
}
})();
