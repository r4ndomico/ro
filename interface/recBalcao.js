...
(function() {
if (dwr.engine._getObject("recBalcao") == undefined) {
var p;
...
return dwr.engine._execute(p._path, 'recBalcao', 'create', arguments);
};
...
p.logRecibo = function(p0, callback) {
return dwr.engine._execute(p._path, 'recBalcao', 'logRecibo', arguments);
};
...
p.createRecibo = function(p0, callback) {
return dwr.engine._execute(p._path, 'recBalcao', 'createRecibo', arguments);
};

dwr.engine._setObject("recBalcao", p);
}
})();
