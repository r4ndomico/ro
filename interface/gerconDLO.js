...
(function() {
if (dwr.engine._getObject("gerconDLO") == undefined) {
var p;
...
return dwr.engine._execute(p._path, 'gerconDLO', 'getInstance', arguments);
};
...
p.verificarProtocolo = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'gerconDLO', 'verificarProtocolo', arguments);
};
...
p.enviaProcoloGercon = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'gerconDLO', 'enviaProcoloGercon', arguments);
};
...
p.enviaProcoloGercon = function(p0, callback) {
return dwr.engine._execute(p._path, 'gerconDLO', 'enviaProcoloGercon', arguments);
};

dwr.engine._setObject("gerconDLO", p);
}
})();
