...
(function() {
if (dwr.engine._getObject("agendaDLO") == undefined) {
var p;
...
p.tipoAgenda = function(p0, callback) {
return dwr.engine._execute(p._path, 'agendaDLO', 'tipoAgenda', arguments);
};
...
p.tipoAgendaExtenso = function(p0, callback) {
return dwr.engine._execute(p._path, 'agendaDLO', 'tipoAgendaExtenso', arguments);
};
...
p.recuperaAgenda = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'agendaDLO', 'recuperaAgenda', arguments);
};

dwr.engine._setObject("agendaDLO", p);
}
})();
