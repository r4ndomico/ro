...
(function() {
if (dwr.engine._getObject("visitaDLO") == undefined) {
var p;
...
p.buscaResumoVisitas = function(p0, callback) {
return dwr.engine._execute(p._path, 'visitaDLO', 'buscaResumoVisitas', arguments);
};
...
p.buscaResumoVisitas = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'visitaDLO', 'buscaResumoVisitas', arguments);
};
...
p.buscaResumoCipVisita = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'visitaDLO', 'buscaResumoCipVisita', arguments);
};
...
p.buscaResumoVisitasLimit = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'visitaDLO', 'buscaResumoVisitasLimit', arguments);
};
...
p.buscaResumoVisitasLimit = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'visitaDLO', 'buscaResumoVisitasLimit', arguments);
};
...
p.montaListaDocumentos = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'visitaDLO', 'montaListaDocumentos', arguments);
};
...
p.buscaResumoVisitasEnvelope = function(p0, callback) {
return dwr.engine._execute(p._path, 'visitaDLO', 'buscaResumoVisitasEnvelope', arguments);
};
...
p.recuperaPreAdmWpd = function(p0, callback) {
return dwr.engine._execute(p._path, 'visitaDLO', 'recuperaPreAdmWpd', arguments);
};

dwr.engine._setObject("visitaDLO", p);
}
})();
