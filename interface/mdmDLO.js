...
(function() {
if (dwr.engine._getObject("mdmDLO") == undefined) {
var p;
...
return dwr.engine._execute(p._path, 'mdmDLO', 'getInstance', arguments);
};
...
p.findByDocument = function(p0, callback) {
return dwr.engine._execute(p._path, 'mdmDLO', 'findByDocument', arguments);
};

dwr.engine._setObject("mdmDLO", p);
}
})();
