...
(function() {
if (dwr.engine._getObject("preventSeniorDLO") == undefined) {
var p;
...
return dwr.engine._execute(p._path, 'preventSeniorDLO', 'getInstance', arguments);
};




p.listarLoginsDeMarcas = function(callback) {
return dwr.engine._execute(p._path, 'preventSeniorDLO', 'listarLoginsDeMarcas', arguments);
};
...
p.solicitarGuiasExames = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'preventSeniorDLO', 'solicitarGuiasExames', arguments);
};
...
p.obterListaExamesPreventSenior = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'preventSeniorDLO', 'obterListaExamesPreventSenior', arguments);
};
...
p.obterListaExamesGliese = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'preventSeniorDLO', 'obterListaExamesGliese', arguments);
};
...
p.cancelarGuiaExame = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'preventSeniorDLO', 'cancelarGuiaExame', arguments);
};
...
p.processarGuiasPreventSenior = function(p0, p1, p2, p3, p4, callback) {
return dwr.engine._execute(p._path, 'preventSeniorDLO', 'processarGuiasPreventSenior', arguments);
};
...
p.listarPedidosMedicosPorPaciente = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'preventSeniorDLO', 'listarPedidosMedicosPorPaciente', arguments);
};

dwr.engine._setObject("preventSeniorDLO", p);
}
})();
