...
(function() {
if (dwr.engine._getObject("convenioDLO") == undefined) {
var p;
...
return dwr.engine._execute(p._path, 'convenioDLO', 'findByMnemonicoUnico', arguments);
};
...
return dwr.engine._execute(p._path, 'convenioDLO', 'obterOperadoras', arguments);
};
...
return dwr.engine._execute(p._path, 'convenioDLO', 'listarConveniosPorExemploEmpresa', arguments);
};
...
p.buscarPorMnemonico = function(p0, callback) {
return dwr.engine._execute(p._path, 'convenioDLO', 'buscarPorMnemonico', arguments);
};
...
p.validaCPFLabet = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'convenioDLO', 'validaCPFLabet', arguments);
};
...
p.obtemProcConvOrcamento = function(p0, callback) {
return dwr.engine._execute(p._path, 'convenioDLO', 'obtemProcConvOrcamento', arguments);
};




p.buscarCombosDoConvenio = function(callback) {
return dwr.engine._execute(p._path, 'convenioDLO', 'buscarCombosDoConvenio', arguments);
};
...
p.verificarVisitaBradescoHoje = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'convenioDLO', 'verificarVisitaBradescoHoje', arguments);
};
...
p.verificaEscalonamento = function(p0, p1, p2, p3, p4, callback) {
return dwr.engine._execute(p._path, 'convenioDLO', 'verificaEscalonamento', arguments);
};
...
p.verificaEscalonamento = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'convenioDLO', 'verificaEscalonamento', arguments);
};
...
p.obterConvenioOnline = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'convenioDLO', 'obterConvenioOnline', arguments);
};
...
p.recuperaGrupoConvenioByCv = function(p0, callback) {
return dwr.engine._execute(p._path, 'convenioDLO', 'recuperaGrupoConvenioByCv', arguments);
};
...
p.verificarPreAmissaoDataHoje = function(p0, callback) {
return dwr.engine._execute(p._path, 'convenioDLO', 'verificarPreAmissaoDataHoje', arguments);
};
...
p.listarMnmonicoConveniosPorEmpresa = function(p0, callback) {
return dwr.engine._execute(p._path, 'convenioDLO', 'listarMnmonicoConveniosPorEmpresa', arguments);
};
...
p.obtemProcConv = function(p0, callback) {
return dwr.engine._execute(p._path, 'convenioDLO', 'obtemProcConv', arguments);
};

dwr.engine._setObject("convenioDLO", p);
}
})();
