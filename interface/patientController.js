...
(function() {
if (dwr.engine._getObject("patientController") == undefined) {
var p;
...
return dwr.engine._execute(p._path, 'patientController', 'save', arguments);
};
...
return dwr.engine._execute(p._path, 'patientController', 'findByResumoNomeDtNascFonetizado', arguments);
};
...
p.buscaHistoricoPaciente = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'patientController', 'buscaHistoricoPaciente', arguments);
};
...
p.obterCipReal = function(p0, callback) {
return dwr.engine._execute(p._path, 'patientController', 'obterCipReal', arguments);
};
...
return dwr.engine._execute(p._path, 'patientController', 'obterPacDiversosPacVipPorCip', arguments);
};
...
p.findPatientByDocumentTypeAndValue = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'patientController', 'findPatientByDocumentTypeAndValue', arguments);
};
...
p.findPatientByDocumentTypeAndValue = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'patientController', 'findPatientByDocumentTypeAndValue', arguments);
};
...
p.saveInOracle = function(p0, p1, p2, p3, p4, callback) {
return dwr.engine._execute(p._path, 'patientController', 'saveInOracle', arguments);
};
...
return dwr.engine._execute(p._path, 'patientController', 'findResumoNomeFonetizado', arguments);
};
...
p.findByReference = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'patientController', 'findByReference', arguments);
};
...
return dwr.engine._execute(p._path, 'patientController', 'findByRg', arguments);
};
...
return dwr.engine._execute(p._path, 'patientController', 'findResumoByCpf', arguments);
};
...
p.atualiza = function(p0, p1, p2, p3, p4, callback) {
return dwr.engine._execute(p._path, 'patientController', 'atualiza', arguments);
};
...
return dwr.engine._execute(p._path, 'patientController', 'findResumoByMatric', arguments);
};
...
return dwr.engine._execute(p._path, 'patientController', 'obterPaciente', arguments);
};
...
return dwr.engine._execute(p._path, 'patientController', 'isSupervisorValido', arguments);
};
...
p.inactivatePatientByCip = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'patientController', 'inactivatePatientByCip', arguments);
};
...
p.inactivatePatient = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'patientController', 'inactivatePatient', arguments);
};
...
p.activatePatient = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'patientController', 'activatePatient', arguments);
};

dwr.engine._setObject("patientController", p);
}
})();
