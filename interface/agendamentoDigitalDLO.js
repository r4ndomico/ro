...
(function() {
if (dwr.engine._getObject("agendamentoDigitalDLO") == undefined) {
var p;
...
return dwr.engine._execute(p._path, 'agendamentoDigitalDLO', 'getInstance', arguments);
};
...
p.retornaAgendamentosPorUnidade = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'agendamentoDigitalDLO', 'retornaAgendamentosPorUnidade', arguments);
};
...
p.retornaAgendamentosPorCip = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'agendamentoDigitalDLO', 'retornaAgendamentosPorCip', arguments);
};

dwr.engine._setObject("agendamentoDigitalDLO", p);
}
})();
