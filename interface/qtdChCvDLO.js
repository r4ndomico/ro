...
(function() {
if (dwr.engine._getObject("qtdChCvDLO") == undefined) {
var p;
...
p.obterExamesPorCodigoTuss = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'qtdChCvDLO', 'obterExamesPorCodigoTuss', arguments);
};
...
p.findCodAMBeValor = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'qtdChCvDLO', 'findCodAMBeValor', arguments);
};

dwr.engine._setObject("qtdChCvDLO", p);
}
})();
