...
(function() {
if (dwr.engine._getObject("profissionalRealizadorDLO") == undefined) {
var p;
...
p.findResumoProfissionalDLO = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'profissionalRealizadorDLO', 'findResumoProfissionalDLO', arguments);
};
...
p.findResumoProfRealDLO = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'profissionalRealizadorDLO', 'findResumoProfRealDLO', arguments);
};
...
p.listByNomeMaiusculoMinusculo = function(p0, callback) {
return dwr.engine._execute(p._path, 'profissionalRealizadorDLO', 'listByNomeMaiusculoMinusculo', arguments);
};
...
p.listByNome = function(p0, callback) {
return dwr.engine._execute(p._path, 'profissionalRealizadorDLO', 'listByNome', arguments);
};

dwr.engine._setObject("profissionalRealizadorDLO", p);
}
})();
