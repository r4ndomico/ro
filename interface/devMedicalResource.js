...
(function() {
if (dwr.engine._getObject("devMedicalResource") == undefined) {
var p;
...
p.fetchUnimedCuiabaExames = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'devMedicalResource', 'fetchUnimedCuiabaExames', arguments);
};
...
p.fetchUnimedAmericanaExames = function(p0, callback) {
return dwr.engine._execute(p._path, 'devMedicalResource', 'fetchUnimedAmericanaExames', arguments);
};

dwr.engine._setObject("devMedicalResource", p);
}
})();
