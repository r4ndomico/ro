...
(function() {
if (dwr.engine._getObject("fontePagadoraDLO") == undefined) {
var p;
...
return dwr.engine._execute(p._path, 'fontePagadoraDLO', 'getInstance', arguments);
};
...
p.validarElegibilidade = function(p0, p1, p2, p3, p4, p5, callback) {
return dwr.engine._execute(p._path, 'fontePagadoraDLO', 'validarElegibilidade', arguments);
};
...
p.verificarElegibilidade = function(p0, p1, p2, p3, p4, p5, p6, p7, callback) {
return dwr.engine._execute(p._path, 'fontePagadoraDLO', 'verificarElegibilidade', arguments);
};




p.buscarJustificativas = function(callback) {
return dwr.engine._execute(p._path, 'fontePagadoraDLO', 'buscarJustificativas', arguments);
};

dwr.engine._setObject("fontePagadoraDLO", p);
}
})();
