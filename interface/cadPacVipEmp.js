...
(function() {
if (dwr.engine._getObject("cadPacVipEmp") == undefined) {
var p;
...
return dwr.engine._execute(p._path, 'cadPacVipEmp', 'findByCip', arguments);
};
...
dwr.engine._setObject("cadPacVipEmp", p);
}
})();
