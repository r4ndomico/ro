...
(function() {
if (dwr.engine._getObject("exaNpcDAO") == undefined) {
var p;
...
p.isExisteUnidadeAtendimentoExaNpc = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'exaNpcDAO', 'isExisteUnidadeAtendimentoExaNpc', arguments);
};
...
p.verificaUnidadeNRealiza = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'exaNpcDAO', 'verificaUnidadeNRealiza', arguments);
};

dwr.engine._setObject("exaNpcDAO", p);
}
})();
