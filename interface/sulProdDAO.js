...
(function() {
if (dwr.engine._getObject("sulProdDAO") == undefined) {
var p;
...
return dwr.engine._execute(p._path, 'sulProdDAO', 'findAll', arguments);
};
...
p.findByConvenio = function(p0, callback) {
return dwr.engine._execute(p._path, 'sulProdDAO', 'findByConvenio', arguments);
};

dwr.engine._setObject("sulProdDAO", p);
}
})();
