...
(function() {
if (dwr.engine._getObject("campanhaDLO") == undefined) {
var p;
...
p.findCampanhas = function(p0, p1, p2, p3, p4, callback) {
return dwr.engine._execute(p._path, 'campanhaDLO', 'findCampanhas', arguments);
};
...
p.imprimirEtiquetaCampanha = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'campanhaDLO', 'imprimirEtiquetaCampanha', arguments);
};
...
p.salvarParticipacaoCampanha = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'campanhaDLO', 'salvarParticipacaoCampanha', arguments);
};

dwr.engine._setObject("campanhaDLO", p);
}
})();
