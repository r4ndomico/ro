...
(function() {
if (dwr.engine._getObject("procedenciaMarcaDAO") == undefined) {
var p;
...
p.buscarDadosRelAdmitidosProcedencia = function(p0, p1, p2, p3, p4, callback) {
return dwr.engine._execute(p._path, 'procedenciaMarcaDAO', 'buscarDadosRelAdmitidosProcedencia', arguments);
};
...
p.findByEmpresa = function(p0, callback) {
return dwr.engine._execute(p._path, 'procedenciaMarcaDAO', 'findByEmpresa', arguments);
};
...
p.isEmpresaPossuiProcedenciaMarca = function(p0, callback) {
return dwr.engine._execute(p._path, 'procedenciaMarcaDAO', 'isEmpresaPossuiProcedenciaMarca', arguments);
};

dwr.engine._setObject("procedenciaMarcaDAO", p);
}
})();
