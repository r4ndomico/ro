...
(function() {
if (dwr.engine._getObject("utilDLO") == undefined) {
var p;
...
p.lock = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'utilDLO', 'lock', arguments);
};
...
return dwr.engine._execute(p._path, 'utilDLO', 'liberaLock', arguments);
};
...
p.dataAtual = function(callback) {
return dwr.engine._execute(p._path, 'utilDLO', 'dataAtual', arguments);
};
...
p.getDataHora = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'utilDLO', 'getDataHora', arguments);
};
...
p.getDiferencaEmDias = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'utilDLO', 'getDiferencaEmDias', arguments);
};
...
p.generateReportXLS = function(p0, p1, p3, callback) {
return dwr.engine._execute(p._path, 'utilDLO', 'generateReportXLS', arguments);
};
...
p.dataHoraAtual = function(p0, callback) {
return dwr.engine._execute(p._path, 'utilDLO', 'dataHoraAtual', arguments);
};
...
p.formatarConveniosExamesAgendamento = function(p0, callback) {
return dwr.engine._execute(p._path, 'utilDLO', 'formatarConveniosExamesAgendamento', arguments);
};
...
p.gravaDWRMensagem = function(p0, callback) {
return dwr.engine._execute(p._path, 'utilDLO', 'gravaDWRMensagem', arguments);
};




p.dataAtualBarras = function(callback) {
return dwr.engine._execute(p._path, 'utilDLO', 'dataAtualBarras', arguments);
};
...
p.limpaNulos = function(p0, callback) {
return dwr.engine._execute(p._path, 'utilDLO', 'limpaNulos', arguments);
};
...
p.sessaoValida = function(p0, callback) {
return dwr.engine._execute(p._path, 'utilDLO', 'sessaoValida', arguments);
};
...
p.horaAtual = function(p0, callback) {
return dwr.engine._execute(p._path, 'utilDLO', 'horaAtual', arguments);
};
...
p.conveteStringParaData = function(p0, callback) {
return dwr.engine._execute(p._path, 'utilDLO', 'conveteStringParaData', arguments);
};
...
p.dataHojeDiferenca = function(p0, callback) {
return dwr.engine._execute(p._path, 'utilDLO', 'dataHojeDiferenca', arguments);
};
...
p.dataHoraAtualFuso = function(p0, callback) {
return dwr.engine._execute(p._path, 'utilDLO', 'dataHoraAtualFuso', arguments);
};
...
p.alteraUnidadeSessao = function(p0, callback) {
return dwr.engine._execute(p._path, 'utilDLO', 'alteraUnidadeSessao', arguments);
};




p.recuperaMsgsTemplate = function(callback) {
return dwr.engine._execute(p._path, 'utilDLO', 'recuperaMsgsTemplate', arguments);
};
...
p.dataAtualFormatada = function(p0, callback) {
return dwr.engine._execute(p._path, 'utilDLO', 'dataAtualFormatada', arguments);
};
...
p.divideEmArrayDeLinhas = function(p0, callback) {
return dwr.engine._execute(p._path, 'utilDLO', 'divideEmArrayDeLinhas', arguments);
};
...
p.alteraUnidadeEmpresaSessao = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'utilDLO', 'alteraUnidadeEmpresaSessao', arguments);
};
...
p.recuperarValorPc = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'utilDLO', 'recuperarValorPc', arguments);
};
...
p.changeCase = function(p0, callback) {
return dwr.engine._execute(p._path, 'utilDLO', 'changeCase', arguments);
};
...
p.recuperarValorPaciente = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'utilDLO', 'recuperarValorPaciente', arguments);
};
...
p.mostraEstatisticasEhCache = function(p0, callback) {
return dwr.engine._execute(p._path, 'utilDLO', 'mostraEstatisticasEhCache', arguments);
};

dwr.engine._setObject("utilDLO", p);
}
})();
