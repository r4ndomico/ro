...
(function() {
if (dwr.engine._getObject("validaCvDLO") == undefined) {
var p;
...
p.converteDataAdmissao = function(p0, callback) {
return dwr.engine._execute(p._path, 'validaCvDLO', 'converteDataAdmissao', arguments);
};
...
p.validaVisita = function(p0, p1, p2, p3, p4, p5, p6, p7, p8, callback) {
return dwr.engine._execute(p._path, 'validaCvDLO', 'validaVisita', arguments);
};
...
p.validaVisita = function(p0, p1, p2, p3, p4, p5, p6, callback) {
return dwr.engine._execute(p._path, 'validaCvDLO', 'validaVisita', arguments);
};
...
p.validaVisita = function(p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, callback) {
return dwr.engine._execute(p._path, 'validaCvDLO', 'validaVisita', arguments);
};
...
p.obterNumeroGuiaPrincipal = function(p0, callback) {
return dwr.engine._execute(p._path, 'validaCvDLO', 'obterNumeroGuiaPrincipal', arguments);
};
...
p.verificaElegibilidade = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'validaCvDLO', 'verificaElegibilidade', arguments);
};
...
p.verificaElegibilidade = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'validaCvDLO', 'verificaElegibilidade', arguments);
};
...
p.visitaJaPreAprovada = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'validaCvDLO', 'visitaJaPreAprovada', arguments);
};
...
p.ehGuiaTissV4 = function(p0, callback) {
return dwr.engine._execute(p._path, 'validaCvDLO', 'ehGuiaTissV4', arguments);
};

dwr.engine._setObject("validaCvDLO", p);
}
})();
