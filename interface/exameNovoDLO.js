...
(function() {
if (dwr.engine._getObject("exameNovoDLO") == undefined) {
var p;
...
return dwr.engine._execute(p._path, 'exameNovoDLO', 'getInstance', arguments);
};
...
return dwr.engine._execute(p._path, 'exameNovoDLO', 'reservarEstoqueDeVacina', arguments);
};
...
return dwr.engine._execute(p._path, 'exameNovoDLO', 'consultaEstoqueVacina', arguments);
};




p.getCaracteresBuscaExames = function(callback) {
return dwr.engine._execute(p._path, 'exameNovoDLO', 'getCaracteresBuscaExames', arguments);
};
...
p.listarExamesPorExemplo = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'exameNovoDLO', 'listarExamesPorExemplo', arguments);
};
...
p.listarExamesPorExemplo = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'exameNovoDLO', 'listarExamesPorExemplo', arguments);
};
...
p.listarExamesExigeSenhaPrevia = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'exameNovoDLO', 'listarExamesExigeSenhaPrevia', arguments);
};

dwr.engine._setObject("exameNovoDLO", p);
}
})();
