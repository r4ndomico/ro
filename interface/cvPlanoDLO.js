...
(function() {
if (dwr.engine._getObject("cvPlanoDLO") == undefined) {
var p;
...
p.listarPlanosComStatusAtivo = function(p0, callback) {
return dwr.engine._execute(p._path, 'cvPlanoDLO', 'listarPlanosComStatusAtivo', arguments);
};
...
p.obterProcedimentosPlano = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'cvPlanoDLO', 'obterProcedimentosPlano', arguments);
};
...
p.obtemPlanosPorOperadora = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'cvPlanoDLO', 'obtemPlanosPorOperadora', arguments);
};
...
p.listByConvenio = function(p0, callback) {
return dwr.engine._execute(p._path, 'cvPlanoDLO', 'listByConvenio', arguments);
};

dwr.engine._setObject("cvPlanoDLO", p);
}
})();
