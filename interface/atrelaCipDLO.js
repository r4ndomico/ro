...
(function() {
if (dwr.engine._getObject("atrelaCipDLO") == undefined) {
var p;
...
return dwr.engine._execute(p._path, 'atrelaCipDLO', 'obterCipReal', arguments);
};
...
return dwr.engine._execute(p._path, 'atrelaCipDLO', 'validaCip', arguments);
};
...
return dwr.engine._execute(p._path, 'atrelaCipDLO', 'obterUltimaVisita', arguments);
};
...
p.obterCipRealImediata = function(p0, callback) {
return dwr.engine._execute(p._path, 'atrelaCipDLO', 'obterCipRealImediata', arguments);
};
...
p.desatrelarCip = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'atrelaCipDLO', 'desatrelarCip', arguments);
};
...
p.existeCip = function(p0, callback) {
return dwr.engine._execute(p._path, 'atrelaCipDLO', 'existeCip', arguments);
};
...
p.atrelarCip = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'atrelaCipDLO', 'atrelarCip', arguments);
};
...
p.forcarDesatrelarCip = function(p0, callback) {
return dwr.engine._execute(p._path, 'atrelaCipDLO', 'forcarDesatrelarCip', arguments);
};

dwr.engine._setObject("atrelaCipDLO", p);
}
})();
