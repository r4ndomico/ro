...
(function() {
if (dwr.engine._getObject("tratativaAgendamentoDLO") == undefined) {
var p;
...
return dwr.engine._execute(p._path, 'tratativaAgendamentoDLO', 'getInstance', arguments);
};
...
p.obterTratativasAgendamentos = function(p0, p1, p2, p3, p4, p5, callback) {
return dwr.engine._execute(p._path, 'tratativaAgendamentoDLO', 'obterTratativasAgendamentos', arguments);
};
...
return dwr.engine._execute(p._path, 'tratativaAgendamentoDLO', 'buscarExameNomeEMnemonico', arguments);
};

dwr.engine._setObject("tratativaAgendamentoDLO", p);
}
})();
