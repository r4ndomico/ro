...
(function() {
if (dwr.engine._getObject("admPartesDLO") == undefined) {
var p;
...
p.obterParte1 = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'admPartesDLO', 'obterParte1', arguments);
};
...
p.obterParte1 = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'admPartesDLO', 'obterParte1', arguments);
};
...
p.obterVisitaAnterior = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'admPartesDLO', 'obterVisitaAnterior', arguments);
};
...
p.obterCvParte0 = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'admPartesDLO', 'obterCvParte0', arguments);
};
...
p.obterParte3 = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'admPartesDLO', 'obterParte3', arguments);
};
...
p.obterParte3 = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'admPartesDLO', 'obterParte3', arguments);
};
...
p.obterParte2 = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'admPartesDLO', 'obterParte2', arguments);
};

dwr.engine._setObject("admPartesDLO", p);
}
})();
