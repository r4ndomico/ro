...
(function() {
if (dwr.engine._getObject("financeiroDLO") == undefined) {
var p;
...
p.empresaUtilizaEmSaldo = function(p0, callback) {
return dwr.engine._execute(p._path, 'financeiroDLO', 'empresaUtilizaEmSaldo', arguments);
};
...
p.insereMPacFinExc = function(p0, callback) {
return dwr.engine._execute(p._path, 'financeiroDLO', 'insereMPacFinExc', arguments);
};
...
p.insereMPacFinDeve = function(p0, callback) {
return dwr.engine._execute(p._path, 'financeiroDLO', 'insereMPacFinDeve', arguments);
};
...
p.cancelaRPS = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'financeiroDLO', 'cancelaRPS', arguments);
};
...
p.inativaTodos = function(p0, callback) {
return dwr.engine._execute(p._path, 'financeiroDLO', 'inativaTodos', arguments);
};
...
p.obterRpsNf = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'financeiroDLO', 'obterRpsNf', arguments);
};

dwr.engine._setObject("financeiroDLO", p);
}
})();
