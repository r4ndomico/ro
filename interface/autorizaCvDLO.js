...
(function() {
if (dwr.engine._getObject("autorizaCvDLO") == undefined) {
var p;
...
p.listarVisitasAprovadas = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'autorizaCvDLO', 'listarVisitasAprovadas', arguments);
};
...
p.listarVisitasAprovadas = function(p0, p1, p2, p3, p4, p5, callback) {
return dwr.engine._execute(p._path, 'autorizaCvDLO', 'listarVisitasAprovadas', arguments);
};
...
p.listarVisitasAprovadas = function(p0, p1, p2, p3, p4, callback) {
return dwr.engine._execute(p._path, 'autorizaCvDLO', 'listarVisitasAprovadas', arguments);
};
...
p.listarVisitasAprovadas = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'autorizaCvDLO', 'listarVisitasAprovadas', arguments);
};
...
p.buscarJustificativasConfirmacaoTokenAmil = function(callback) {
return dwr.engine._execute(p._path, 'autorizaCvDLO', 'buscarJustificativasConfirmacaoTokenAmil', arguments);
};
...
p.obterTokensSenhaPrevia = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'autorizaCvDLO', 'obterTokensSenhaPrevia', arguments);
};
...
p.obterListaGuiaOperadora = function(p0, p1, p2, p3, p4, callback) {
return dwr.engine._execute(p._path, 'autorizaCvDLO', 'obterListaGuiaOperadora', arguments);
};
...
p.obterGuiaOperadora = function(p0, p1, p2, p3, p4, callback) {
return dwr.engine._execute(p._path, 'autorizaCvDLO', 'obterGuiaOperadora', arguments);
};
...
p.obterListaVisitasAprovadas = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'autorizaCvDLO', 'obterListaVisitasAprovadas', arguments);
};
...
p.obterMapGuiaPrestadorGuiaOperadora = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'autorizaCvDLO', 'obterMapGuiaPrestadorGuiaOperadora', arguments);
};
...
p.listarSenhasComTokenAmil = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'autorizaCvDLO', 'listarSenhasComTokenAmil', arguments);
};
...
return dwr.engine._execute(p._path, 'autorizaCvDLO', 'verificaSeVoucherUtilizado', arguments);
};
...
p.gravaAutorizacao = function(p0, callback) {
return dwr.engine._execute(p._path, 'autorizaCvDLO', 'gravaAutorizacao', arguments);
};
...
p.excluiAutorizacao = function(p0, callback) {
return dwr.engine._execute(p._path, 'autorizaCvDLO', 'excluiAutorizacao', arguments);
};
...
p.obterListaGuiaPrestador = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'autorizaCvDLO', 'obterListaGuiaPrestador', arguments);
};
...
p.verificaAprovado = function(p0, p1, p2, p3, p4, callback) {
return dwr.engine._execute(p._path, 'autorizaCvDLO', 'verificaAprovado', arguments);
};
...
p.verificaAprovado = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'autorizaCvDLO', 'verificaAprovado', arguments);
};
...
p.verificaAprovado = function(p0, p1, p2, p3, p4, p5, callback) {
return dwr.engine._execute(p._path, 'autorizaCvDLO', 'verificaAprovado', arguments);
};
...
p.obterTokensPendentes = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'autorizaCvDLO', 'obterTokensPendentes', arguments);
};
...
p.verificaExameValidadoOnline = function(p0, p1, p2, p3, p4, callback) {
return dwr.engine._execute(p._path, 'autorizaCvDLO', 'verificaExameValidadoOnline', arguments);
};
...
p.buscarTokenJaAdmitidoGoldenCross = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'autorizaCvDLO', 'buscarTokenJaAdmitidoGoldenCross', arguments);
};

dwr.engine._setObject("autorizaCvDLO", p);
}
})();
