...
(function() {
if (dwr.engine._getObject("triagemDLO") == undefined) {
var p;
...
return dwr.engine._execute(p._path, 'triagemDLO', 'atualizaCipTriagem', arguments);
};
...
return dwr.engine._execute(p._path, 'triagemDLO', 'recuperaFilaPorTipo', arguments);
};
...
p.inserePacNaFilaRetornaObjeto = function(p0, callback) {
return dwr.engine._execute(p._path, 'triagemDLO', 'inserePacNaFilaRetornaObjeto', arguments);
};
...
return dwr.engine._execute(p._path, 'triagemDLO', 'recuperaPacTriagem', arguments);
};
...
return dwr.engine._execute(p._path, 'triagemDLO', 'inserePacNaFila', arguments);
};
...
p.recuperaMovimentoTriagem = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'triagemDLO', 'recuperaMovimentoTriagem', arguments);
};
...
p.inserePacienteTotemNaFila = function(p0, p1, p2, p3, p4, callback) {
return dwr.engine._execute(p._path, 'triagemDLO', 'inserePacienteTotemNaFila', arguments);
};
...
p.calcularTmaTme = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'triagemDLO', 'calcularTmaTme', arguments);
};
...
p.recuperaFilaPorTipo2 = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'triagemDLO', 'recuperaFilaPorTipo2', arguments);
};
...
return dwr.engine._execute(p._path, 'triagemDLO', 'recuperaTempoAtendimento', arguments);
};
...
p.recuperarTmaTmePorSetor = function(p0, p1, p2, p3, p4, callback) {
return dwr.engine._execute(p._path, 'triagemDLO', 'recuperarTmaTmePorSetor', arguments);
};

dwr.engine._setObject("triagemDLO", p);
}
})();
