...
(function() {
if (dwr.engine._getObject("filaColetaNovaDLO") == undefined) {
var p;
...
return dwr.engine._execute(p._path, 'filaColetaNovaDLO', 'getInstance', arguments);
};
...
return dwr.engine._execute(p._path, 'filaColetaNovaDLO', 'sincroniza', arguments);
};
...
p.listarFilasDoPaciente = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'filaColetaNovaDLO', 'listarFilasDoPaciente', arguments);
};
...
p.obterLoteVacina = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'filaColetaNovaDLO', 'obterLoteVacina', arguments);
};

dwr.engine._setObject("filaColetaNovaDLO", p);
}
})();
