...
(function() {
if (dwr.engine._getObject("mPacDivDLO") == undefined) {
var p;
...
p.obterMPacDiv = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'mPacDivDLO', 'obterMPacDiv', arguments);
};
...
p.buscaPesoAltura = function(p0, callback) {
return dwr.engine._execute(p._path, 'mPacDivDLO', 'buscaPesoAltura', arguments);
};
...
p.atualizaPesoAltura = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'mPacDivDLO', 'atualizaPesoAltura', arguments);
};
...
p.buscarMedicamento = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'mPacDivDLO', 'buscarMedicamento', arguments);
};




p.consultarMitoJejum = function(callback) {
return dwr.engine._execute(p._path, 'mPacDivDLO', 'consultarMitoJejum', arguments);
};
...
p.buscaMotivoCancelamento = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'mPacDivDLO', 'buscaMotivoCancelamento', arguments);
};
...
p.setMotivoCancelamento = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'mPacDivDLO', 'setMotivoCancelamento', arguments);
};
...
p.atualizaEnvioSmsLaudoPronto = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'mPacDivDLO', 'atualizaEnvioSmsLaudoPronto', arguments);
};
...
p.buscaEnvioSmsLaudoPronto = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'mPacDivDLO', 'buscaEnvioSmsLaudoPronto', arguments);
};

dwr.engine._setObject("mPacDivDLO", p);
}
})();
