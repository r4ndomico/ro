...
(function() {
if (dwr.engine._getObject("mPacRpsDAO") == undefined) {
var p;
...
p.findMPacRps = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'mPacRpsDAO', 'findMPacRps', arguments);
};
...
p.findMPacRps = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'mPacRpsDAO', 'findMPacRps', arguments);
};
...
p.updateMPacRpsObservacao = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'mPacRpsDAO', 'updateMPacRpsObservacao', arguments);
};
...
p.permiteImpressaoRpsConclusao = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'mPacRpsDAO', 'permiteImpressaoRpsConclusao', arguments);
};

dwr.engine._setObject("mPacRpsDAO", p);
}
})();
