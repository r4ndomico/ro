...
(function() {
if (dwr.engine._getObject("empImgIntegraDLO") == undefined) {
var p;
...
return dwr.engine._execute(p._path, 'empImgIntegraDLO', 'getInstance', arguments);
};
...
p.buscarIntegracaoPorMarca = function(p0, callback) {
return dwr.engine._execute(p._path, 'empImgIntegraDLO', 'buscarIntegracaoPorMarca', arguments);
};

dwr.engine._setObject("empImgIntegraDLO", p);
}
})();
