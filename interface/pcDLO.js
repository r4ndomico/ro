...
(function() {
if (dwr.engine._getObject("pcDLO") == undefined) {
var p;
...
return dwr.engine._execute(p._path, 'pcDLO', 'getInstance', arguments);
};
...
return dwr.engine._execute(p._path, 'pcDLO', 'findByCodigo', arguments);
};
...
return dwr.engine._execute(p._path, 'pcDLO', 'findByMnemonico', arguments);
};
...
return dwr.engine._execute(p._path, 'pcDLO', 'busacaMetasPorMnemonicoPc', arguments);
};
...
p.isUnidadeValidaParaAdmissao = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'pcDLO', 'isUnidadeValidaParaAdmissao', arguments);
};
...
return dwr.engine._execute(p._path, 'pcDLO', 'exigeNomeMae', arguments);
};
...
p.obterDataPcFusoHorario = function(p0, callback) {
return dwr.engine._execute(p._path, 'pcDLO', 'obterDataPcFusoHorario', arguments);
};
...
p.findMottionByCodigo = function(p0, callback) {
return dwr.engine._execute(p._path, 'pcDLO', 'findMottionByCodigo', arguments);
};
...
return dwr.engine._execute(p._path, 'pcDLO', 'permiteEnvioSms', arguments);
};
...
p.isPcUsesMotion = function(p0, callback) {
return dwr.engine._execute(p._path, 'pcDLO', 'isPcUsesMotion', arguments);
};
...
p.buscaMinutosFimParaAlertaDeExameUrgente = function(p0, p1, p2, p3, p4, callback) {
return dwr.engine._execute(p._path, 'pcDLO', 'buscaMinutosFimParaAlertaDeExameUrgente', arguments);
};
...
p.unidadeAtendImprimeEtiquetaNaRecepcao = function(p0, callback) {
return dwr.engine._execute(p._path, 'pcDLO', 'unidadeAtendImprimeEtiquetaNaRecepcao', arguments);
};
...
return dwr.engine._execute(p._path, 'pcDLO', 'buscaTipoUnidade', arguments);
};
...
p.findMottionByUnidadeRealizacao = function(p0, callback) {
return dwr.engine._execute(p._path, 'pcDLO', 'findMottionByUnidadeRealizacao', arguments);
};

dwr.engine._setObject("pcDLO", p);
}
})();
