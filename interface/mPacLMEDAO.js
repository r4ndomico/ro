...
(function() {
if (dwr.engine._getObject("mPacLMEDAO") == undefined) {
var p;
...
return dwr.engine._execute(p._path, 'mPacLMEDAO', 'salva', arguments);
};
...
p.findMPacLMEbyCipVisita = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'mPacLMEDAO', 'findMPacLMEbyCipVisita', arguments);
};
...
p.findMPacLMEbyCipVisita = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'mPacLMEDAO', 'findMPacLMEbyCipVisita', arguments);
};
...
p.obterMPacLMEbyCipVisita = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'mPacLMEDAO', 'obterMPacLMEbyCipVisita', arguments);
};

dwr.engine._setObject("mPacLMEDAO", p);
}
})();
