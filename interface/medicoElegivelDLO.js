...
(function() {
if (dwr.engine._getObject("medicoElegivelDLO") == undefined) {
var p;
...
return dwr.engine._execute(p._path, 'medicoElegivelDLO', 'getInstance', arguments);
};
...
p.medicoEhElegivel = function(p0, callback) {
return dwr.engine._execute(p._path, 'medicoElegivelDLO', 'medicoEhElegivel', arguments);
};

dwr.engine._setObject("medicoElegivelDLO", p);
}
})();
