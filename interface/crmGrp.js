...
(function() {
if (dwr.engine._getObject("crmGrp") == undefined) {
var p;
...
return dwr.engine._execute(p._path, 'crmGrp', 'update', arguments);
};
...
return dwr.engine._execute(p._path, 'crmGrp', 'create', arguments);
};
...
return dwr.engine._execute(p._path, 'crmGrp', 'liberaLock', arguments);
};
...
p.obterMedicoPorCRM = function(p0, callback) {
return dwr.engine._execute(p._path, 'crmGrp', 'obterMedicoPorCRM', arguments);
};
...
p.findByCrm = function(p0, callback) {
return dwr.engine._execute(p._path, 'crmGrp', 'findByCrm', arguments);
};
...
p.findByCrm = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'crmGrp', 'findByCrm', arguments);
};
...
p.findByCrm = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'crmGrp', 'findByCrm', arguments);
};
...
p.obterDadosBasicos = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'crmGrp', 'obterDadosBasicos', arguments);
};
...
p.obterEspecialidade = function(p0, callback) {
return dwr.engine._execute(p._path, 'crmGrp', 'obterEspecialidade', arguments);
};
...
p.obterSenhaInternet = function(p0, callback) {
return dwr.engine._execute(p._path, 'crmGrp', 'obterSenhaInternet', arguments);
};
...
p.exibeTel = function(p0, callback) {
return dwr.engine._execute(p._path, 'crmGrp', 'exibeTel', arguments);
};
...
p.findByCrms = function(p0, callback) {
return dwr.engine._execute(p._path, 'crmGrp', 'findByCrms', arguments);
};
...
p.findResumoByCrm = function(p0, callback) {
return dwr.engine._execute(p._path, 'crmGrp', 'findResumoByCrm', arguments);
};
...
p.findResumoByCrm = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'crmGrp', 'findResumoByCrm', arguments);
};
...
return dwr.engine._execute(p._path, 'crmGrp', 'findByNome', arguments);
};
...
p.findResumoByNome = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'crmGrp', 'findResumoByNome', arguments);
};
...
p.garanteCadastro = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'crmGrp', 'garanteCadastro', arguments);
};
...
return dwr.engine._execute(p._path, 'crmGrp', 'findHistoricoMedicosByCip', arguments);
};

dwr.engine._setObject("crmGrp", p);
}
})();
