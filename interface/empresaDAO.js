...
(function() {
if (dwr.engine._getObject("empresaDAO") == undefined) {
var p;
...
p.obterPorCodigo = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'empresaDAO', 'obterPorCodigo', arguments);
};
...
p.obterPorCodigo = function(p0, callback) {
return dwr.engine._execute(p._path, 'empresaDAO', 'obterPorCodigo', arguments);
};
...
return dwr.engine._execute(p._path, 'empresaDAO', 'findByCodigo', arguments);
};
...
p.findAll = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'empresaDAO', 'findAll', arguments);
};
...
p.findAll = function(p0, callback) {
return dwr.engine._execute(p._path, 'empresaDAO', 'findAll', arguments);
};
...
p.obterPorMnmUnidade = function(p0, callback) {
return dwr.engine._execute(p._path, 'empresaDAO', 'obterPorMnmUnidade', arguments);
};
...
p.obterTipoEscalonamento = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'empresaDAO', 'obterTipoEscalonamento', arguments);
};
...
p.obterTipoEscalonamento = function(p0, callback) {
return dwr.engine._execute(p._path, 'empresaDAO', 'obterTipoEscalonamento', arguments);
};
...
p.obterCodigoFilaAtend = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'empresaDAO', 'obterCodigoFilaAtend', arguments);
};
...
p.findAllPorNome = function(p0, callback) {
return dwr.engine._execute(p._path, 'empresaDAO', 'findAllPorNome', arguments);
};

dwr.engine._setObject("empresaDAO", p);
}
})();
