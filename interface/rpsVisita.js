...
(function() {
if (dwr.engine._getObject("rpsVisita") == undefined) {
var p;
...
return dwr.engine._execute(p._path, 'rpsVisita', 'main', arguments);
};
...
p.processarRps = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'rpsVisita', 'processarRps', arguments);
};
...
p.montaArquivoCancelaMasterSAF = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'rpsVisita', 'montaArquivoCancelaMasterSAF', arguments);
};
...
p.visitaGeraNfe = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'rpsVisita', 'visitaGeraNfe', arguments);
};




p.numeroTentativasNfe = function(callback) {
return dwr.engine._execute(p._path, 'rpsVisita', 'numeroTentativasNfe', arguments);
};
...
p.getNumeroRpsWS = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'rpsVisita', 'getNumeroRpsWS', arguments);
};
...
p.isObersvacaoEditavel = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'rpsVisita', 'isObersvacaoEditavel', arguments);
};
...
p.getObervacaoRps = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'rpsVisita', 'getObervacaoRps', arguments);
};

dwr.engine._setObject("rpsVisita", p);
}
})();
