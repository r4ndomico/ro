...
(function() {
if (dwr.engine._getObject("sapDLO") == undefined) {
var p;
...
return dwr.engine._execute(p._path, 'sapDLO', 'getInstance', arguments);
};
...
p.cancelaEstoqueDeVacina = function(p0, callback) {
return dwr.engine._execute(p._path, 'sapDLO', 'cancelaEstoqueDeVacina', arguments);
};
...
p.registrarReservaVacina = function(p0, callback) {
return dwr.engine._execute(p._path, 'sapDLO', 'registrarReservaVacina', arguments);
};
...
p.reservarEstoqueDeVacina = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'sapDLO', 'reservarEstoqueDeVacina', arguments);
};
...
p.reservarEstoqueDeVacina = function(p0, p1, p2, p3, p4, p5, callback) {
return dwr.engine._execute(p._path, 'sapDLO', 'reservarEstoqueDeVacina', arguments);
};
...
p.consultarEstoqueVacina = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'sapDLO', 'consultarEstoqueVacina', arguments);
};
...
p.publicarBaixaEstoqueVacina = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'sapDLO', 'publicarBaixaEstoqueVacina', arguments);
};
...
p.efetuarReservaVacina = function(p0, p1, p2, p3, p4, callback) {
return dwr.engine._execute(p._path, 'sapDLO', 'efetuarReservaVacina', arguments);
};
...
p.registarVacinaReserva = function(p0, callback) {
return dwr.engine._execute(p._path, 'sapDLO', 'registarVacinaReserva', arguments);
};
...
p.postarMpacExaVacTopico = function(p0, callback) {
return dwr.engine._execute(p._path, 'sapDLO', 'postarMpacExaVacTopico', arguments);
};
...
p.obterLotesPorCipVisita = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'sapDLO', 'obterLotesPorCipVisita', arguments);
};
...
p.consultaEstoqueVacina = function(p0, p1, p2, p3, p4, p5, callback) {
return dwr.engine._execute(p._path, 'sapDLO', 'consultaEstoqueVacina', arguments);
};

dwr.engine._setObject("sapDLO", p);
}
})();
