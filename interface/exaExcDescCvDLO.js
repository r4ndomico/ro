...
(function() {
if (dwr.engine._getObject("exaExcDescCvDLO") == undefined) {
var p;
...
p.excluiDesconto = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'exaExcDescCvDLO', 'excluiDesconto', arguments);
};

dwr.engine._setObject("exaExcDescCvDLO", p);
}
})();
