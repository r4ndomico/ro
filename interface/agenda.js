...
(function() {
if (dwr.engine._getObject("agenda") == undefined) {
var p;
...
return dwr.engine._execute(p._path, 'agenda', 'findByCodigo', arguments);
};
...
return dwr.engine._execute(p._path, 'agenda', 'findObsByCip', arguments);
};
...
p.findObsByCip = function(p0, callback) {
return dwr.engine._execute(p._path, 'agenda', 'findObsByCip', arguments);
};
...
p.findByDataNome = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'agenda', 'findByDataNome', arguments);
};
...
p.consultarAgendamentosConvertidos = function(p0, p1, p2, p3, p4, callback) {
return dwr.engine._execute(p._path, 'agenda', 'consultarAgendamentosConvertidos', arguments);
};
...
p.atualizarAgendamentoConvertido = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'agenda', 'atualizarAgendamentoConvertido', arguments);
};
...
p.consultarAgendamento = function(p0, p1, p2, p3, p4, callback) {
return dwr.engine._execute(p._path, 'agenda', 'consultarAgendamento', arguments);
};
...
p.marcaAtendido = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'agenda', 'marcaAtendido', arguments);
};
...
p.marcaAtendido = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'agenda', 'marcaAtendido', arguments);
};

dwr.engine._setObject("agenda", p);
}
})();
