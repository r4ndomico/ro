...
(function() {
if (dwr.engine._getObject("labHospitalDLO") == undefined) {
var p;
...
p.findAllByPC = function(p0, callback) {
return dwr.engine._execute(p._path, 'labHospitalDLO', 'findAllByPC', arguments);
};
...
return dwr.engine._execute(p._path, 'labHospitalDLO', 'findAllByGrupo', arguments);
};
...
p.obterPorGrupoEnd = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'labHospitalDLO', 'obterPorGrupoEnd', arguments);
};

dwr.engine._setObject("labHospitalDLO", p);
}
})();
