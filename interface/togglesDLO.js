...
(function() {
if (dwr.engine._getObject("togglesDLO") == undefined) {
var p;
...
return dwr.engine._execute(p._path, 'togglesDLO', 'getInstance', arguments);
};
...
p.getStatusTogglePorFuncionalidadeMarca = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'togglesDLO', 'getStatusTogglePorFuncionalidadeMarca', arguments);
};
...
p.obterTogglesPorFuncionalidadeMarca = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'togglesDLO', 'obterTogglesPorFuncionalidadeMarca', arguments);
};
...
p.toggleStatusLigado = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'togglesDLO', 'toggleStatusLigado', arguments);
};
...
p.salvarTogglesMarca = function(p0, callback) {
return dwr.engine._execute(p._path, 'togglesDLO', 'salvarTogglesMarca', arguments);
};
...
p.obterTogglesPorFuncionalidade = function(p0, callback) {
return dwr.engine._execute(p._path, 'togglesDLO', 'obterTogglesPorFuncionalidade', arguments);
};




p.listarTogglesAtivos = function(callback) {
return dwr.engine._execute(p._path, 'togglesDLO', 'listarTogglesAtivos', arguments);
};
...
p.toggleEstaLigado = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'togglesDLO', 'toggleEstaLigado', arguments);
};
...
p.listarTogglesMarca = function(p0, callback) {
return dwr.engine._execute(p._path, 'togglesDLO', 'listarTogglesMarca', arguments);
};

dwr.engine._setObject("togglesDLO", p);
}
})();
