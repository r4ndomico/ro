...
(function() {
if (dwr.engine._getObject("filaAtendimento") == undefined) {
var p;
...
return dwr.engine._execute(p._path, 'filaAtendimento', 'getServletInfo', arguments);
};
...
p.obtemFila = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'filaAtendimento', 'obtemFila', arguments);
};
...
return dwr.engine._execute(p._path, 'filaAtendimento', 'service', arguments);
};
...
return dwr.engine._execute(p._path, 'filaAtendimento', 'log', arguments);
};
...
return dwr.engine._execute(p._path, 'filaAtendimento', 'init', arguments);
};
...
return dwr.engine._execute(p._path, 'filaAtendimento', 'destroy', arguments);
};
...
return dwr.engine._execute(p._path, 'filaAtendimento', 'getServletContext', arguments);
};
...
return dwr.engine._execute(p._path, 'filaAtendimento', 'getServletName', arguments);
};
...
return dwr.engine._execute(p._path, 'filaAtendimento', 'getInitParameterNames', arguments);
};
...
return dwr.engine._execute(p._path, 'filaAtendimento', 'getInitParameter', arguments);
};
...
return dwr.engine._execute(p._path, 'filaAtendimento', 'getServletConfig', arguments);
};

dwr.engine._setObject("filaAtendimento", p);
}
})();
