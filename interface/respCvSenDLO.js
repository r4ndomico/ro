...
(function() {
if (dwr.engine._getObject("respCvSenDLO") == undefined) {
var p;
...
return dwr.engine._execute(p._path, 'respCvSenDLO', 'salva', arguments);
};
...
p.verificaSeEstaAprovado = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'respCvSenDLO', 'verificaSeEstaAprovado', arguments);
};

dwr.engine._setObject("respCvSenDLO", p);
}
})();
