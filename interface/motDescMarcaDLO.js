...
(function() {
if (dwr.engine._getObject("motDescMarcaDLO") == undefined) {
var p;
...
p.consultarMotivoDescontoMarca = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'motDescMarcaDLO', 'consultarMotivoDescontoMarca', arguments);
};

dwr.engine._setObject("motDescMarcaDLO", p);
}
})();
