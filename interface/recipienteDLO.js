...
(function() {
if (dwr.engine._getObject("recipienteDLO") == undefined) {
var p;
...
p.obterLimiteRecipiente = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'recipienteDLO', 'obterLimiteRecipiente', arguments);
};
...
p.verificaListaRecipiente = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'recipienteDLO', 'verificaListaRecipiente', arguments);
};

dwr.engine._setObject("recipienteDLO", p);
}
})();
