...
(function() {
if (dwr.engine._getObject("criCv") == undefined) {
var p;
...
p.findByMnemonico = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'criCv', 'findByMnemonico', arguments);
};
...
p.findByMnemonico = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'criCv', 'findByMnemonico', arguments);
};
...
return dwr.engine._execute(p._path, 'criCv', 'findByCipVisita', arguments);
};
...
return dwr.engine._execute(p._path, 'criCv', 'obterPorCipVisita', arguments);
};
...
p.findPrazoRec = function(p0, callback) {
return dwr.engine._execute(p._path, 'criCv', 'findPrazoRec', arguments);
};
...
p.obterCriticasConvenioNfa = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'criCv', 'obterCriticasConvenioNfa', arguments);
};
...
p.findTipoMatMedByCipVisita = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'criCv', 'findTipoMatMedByCipVisita', arguments);
};
...
return dwr.engine._execute(p._path, 'criCv', 'setJdbcTemplate', arguments);
};
...
return dwr.engine._execute(p._path, 'criCv', 'getDataSource', arguments);
};
...
return dwr.engine._execute(p._path, 'criCv', 'setDataSource', arguments);
};
...
return dwr.engine._execute(p._path, 'criCv', 'getJdbcTemplate', arguments);
};
...
return dwr.engine._execute(p._path, 'criCv', 'afterPropertiesSet', arguments);
};

dwr.engine._setObject("criCv", p);
}
})();
