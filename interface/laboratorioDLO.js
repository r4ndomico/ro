...
(function() {
if (dwr.engine._getObject("laboratorioDLO") == undefined) {
var p;
...
p.obterLaboratorioPorCodigo = function(p0, callback) {
return dwr.engine._execute(p._path, 'laboratorioDLO', 'obterLaboratorioPorCodigo', arguments);
};

dwr.engine._setObject("laboratorioDLO", p);
}
})();
