...
(function() {
if (dwr.engine._getObject("rAjax") == undefined) {
var p;
...
p.enviaMensagem = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'rAjax', 'enviaMensagem', arguments);
};
...
p.setUnidadeScriptSession = function(p0, callback) {
return dwr.engine._execute(p._path, 'rAjax', 'setUnidadeScriptSession', arguments);
};

dwr.engine._setObject("rAjax", p);
}
})();
