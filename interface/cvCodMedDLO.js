...
(function() {
if (dwr.engine._getObject("cvCodMedDLO") == undefined) {
var p;
...
p.verificaCvCodMed = function(p0, callback) {
return dwr.engine._execute(p._path, 'cvCodMedDLO', 'verificaCvCodMed', arguments);
};

dwr.engine._setObject("cvCodMedDLO", p);
}
})();
