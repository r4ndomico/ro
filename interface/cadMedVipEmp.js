...
(function() {
if (dwr.engine._getObject("cadMedVipEmp") == undefined) {
var p;
...
return dwr.engine._execute(p._path, 'cadMedVipEmp', 'findByCRM', arguments);
};
...
p.findMedVipByNome = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'cadMedVipEmp', 'findMedVipByNome', arguments);
};

dwr.engine._setObject("cadMedVipEmp", p);
}
})();
