...
(function() {
if (dwr.engine._getObject("tokenAmilDLO") == undefined) {
var p;
...
return dwr.engine._execute(p._path, 'tokenAmilDLO', 'getInstance', arguments);
};
...
p.cancelarVisita = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'tokenAmilDLO', 'cancelarVisita', arguments);
};
...
p.listarAtendimentosPendentes = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'tokenAmilDLO', 'listarAtendimentosPendentes', arguments);
};
...
p.listarAtendimentos = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'tokenAmilDLO', 'listarAtendimentos', arguments);
};
...
p.validarToken = function(p0, callback) {
return dwr.engine._execute(p._path, 'tokenAmilDLO', 'validarToken', arguments);
};
...
p.confirmarAtendimento = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'tokenAmilDLO', 'confirmarAtendimento', arguments);
};
...
p.reverterAtendimento = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'tokenAmilDLO', 'reverterAtendimento', arguments);
};




p.listarJustificativas = function(callback) {
return dwr.engine._execute(p._path, 'tokenAmilDLO', 'listarJustificativas', arguments);
};
...
p.inserirNovasSenhasBackoffice = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'tokenAmilDLO', 'inserirNovasSenhasBackoffice', arguments);
};
...
p.atualizaSenhasConvenioPorExames = function(p0, callback) {
return dwr.engine._execute(p._path, 'tokenAmilDLO', 'atualizaSenhasConvenioPorExames', arguments);
};
...
p.criarNovoAtendimento = function(p0, callback) {
return dwr.engine._execute(p._path, 'tokenAmilDLO', 'criarNovoAtendimento', arguments);
};
...
p.excluirSenhaSeTodosExamesExcluidos = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'tokenAmilDLO', 'excluirSenhaSeTodosExamesExcluidos', arguments);
};

dwr.engine._setObject("tokenAmilDLO", p);
}
})();
