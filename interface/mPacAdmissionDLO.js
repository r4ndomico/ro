...
(function() {
if (dwr.engine._getObject("mPacAdmissionDLO") == undefined) {
var p;
...
return dwr.engine._execute(p._path, 'mPacAdmissionDLO', 'getInstance', arguments);
};
...
p.obterValorTotalExamesVindosDoAdmission = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'mPacAdmissionDLO', 'obterValorTotalExamesVindosDoAdmission', arguments);
};
...
p.obterValorTotalExamesVindosDoAdmission = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'mPacAdmissionDLO', 'obterValorTotalExamesVindosDoAdmission', arguments);
};
...
p.temPagamentoOrigemAdmission = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'mPacAdmissionDLO', 'temPagamentoOrigemAdmission', arguments);
};
...
p.verificaOrigemAdmission = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'mPacAdmissionDLO', 'verificaOrigemAdmission', arguments);
};

dwr.engine._setObject("mPacAdmissionDLO", p);
}
})();
