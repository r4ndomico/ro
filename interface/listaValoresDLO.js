...
(function() {
if (dwr.engine._getObject("listaValoresDLO") == undefined) {
var p;
...
return dwr.engine._execute(p._path, 'listaValoresDLO', 'getInstance', arguments);
};
...
p.buscarListaValoresPorDominio = function(p0, callback) {
return dwr.engine._execute(p._path, 'listaValoresDLO', 'buscarListaValoresPorDominio', arguments);
};
...
p.verificarExistePorValorDominio = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'listaValoresDLO', 'verificarExistePorValorDominio', arguments);
};
...
p.buscarListaValoresPorDominioNome = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'listaValoresDLO', 'buscarListaValoresPorDominioNome', arguments);
};
...
p.buscarListaValoresId = function(p0, callback) {
return dwr.engine._execute(p._path, 'listaValoresDLO', 'buscarListaValoresId', arguments);
};
...
p.salvarValorPorDominioNome = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'listaValoresDLO', 'salvarValorPorDominioNome', arguments);
};

dwr.engine._setObject("listaValoresDLO", p);
}
})();
