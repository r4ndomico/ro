...
(function() {
if (dwr.engine._getObject("atdRlExaDAO") == undefined) {
var p;
...
p.findUnidadeRealizacao = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'atdRlExaDAO', 'findUnidadeRealizacao', arguments);
};
...
p.findUnidadeRealizacao = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'atdRlExaDAO', 'findUnidadeRealizacao', arguments);
};

dwr.engine._setObject("atdRlExaDAO", p);
}
})();
