...
(function() {
if (dwr.engine._getObject("criExaMnese") == undefined) {
var p;
...
return dwr.engine._execute(p._path, 'criExaMnese', 'findByMnemonico', arguments);
};
...
return dwr.engine._execute(p._path, 'criExaMnese', 'obterPorMnemonico', arguments);
};
...
p.existeAnamnese = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'criExaMnese', 'existeAnamnese', arguments);
};

dwr.engine._setObject("criExaMnese", p);
}
})();
