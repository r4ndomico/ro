...
(function() {
if (dwr.engine._getObject("backofficeDLO") == undefined) {
var p;
...
return dwr.engine._execute(p._path, 'backofficeDLO', 'getInstance', arguments);
};




p.buscarListaJustificativas = function(callback) {
return dwr.engine._execute(p._path, 'backofficeDLO', 'buscarListaJustificativas', arguments);
};
...
p.obterUUID = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'backofficeDLO', 'obterUUID', arguments);
};
...
p.buscarPendenciasBackOffice = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'backofficeDLO', 'buscarPendenciasBackOffice', arguments);
};
...
p.insertNewStatusBackOffice = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'backofficeDLO', 'insertNewStatusBackOffice', arguments);
};
...
p.retornaListaBackoffice = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'backofficeDLO', 'retornaListaBackoffice', arguments);
};
...
p.updateImagemPreAdm = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'backofficeDLO', 'updateImagemPreAdm', arguments);
};
...
p.findStatusBackOffice = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'backofficeDLO', 'findStatusBackOffice', arguments);
};
...
p.updateStatusBackOffice = function(p0, p1, p2, p3, p4, p5, callback) {
return dwr.engine._execute(p._path, 'backofficeDLO', 'updateStatusBackOffice', arguments);
};
...
p.insereObservacoesDeJustificativasBackOffice = function(p0, callback) {
return dwr.engine._execute(p._path, 'backofficeDLO', 'insereObservacoesDeJustificativasBackOffice', arguments);
};
...
p.buscarInformacoesBotoesNavegacao = function(p0, p1, p2, p3, p4, p5, callback) {
return dwr.engine._execute(p._path, 'backofficeDLO', 'buscarInformacoesBotoesNavegacao', arguments);
};

dwr.engine._setObject("backofficeDLO", p);
}
})();
