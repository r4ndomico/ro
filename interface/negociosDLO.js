...
(function() {
if (dwr.engine._getObject("negociosDLO") == undefined) {
var p;
...
return dwr.engine._execute(p._path, 'negociosDLO', 'getInstance', arguments);
};
...
p.salvarAtualizarAdmissao = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'negociosDLO', 'salvarAtualizarAdmissao', arguments);
};

dwr.engine._setObject("negociosDLO", p);
}
})();
