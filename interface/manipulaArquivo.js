...
(function() {
if (dwr.engine._getObject("manipulaArquivo") == undefined) {
var p;
...
p.le = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'manipulaArquivo', 'le', arguments);
};
...
p.le = function(p0, p1, p2, p3, p4, p5, p6, p7, callback) {
return dwr.engine._execute(p._path, 'manipulaArquivo', 'le', arguments);
};
...
p.cria = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'manipulaArquivo', 'cria', arguments);
};
...
p.pesquisaArquivosNoDiretorio = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'manipulaArquivo', 'pesquisaArquivosNoDiretorio', arguments);
};
...
p.modeloLeituraArquivo = function(p0, callback) {
return dwr.engine._execute(p._path, 'manipulaArquivo', 'modeloLeituraArquivo', arguments);
};
...
p.gravaLog = function(p0, p1, p2, p3, p4, p5, callback) {
return dwr.engine._execute(p._path, 'manipulaArquivo', 'gravaLog', arguments);
};
...
p.gravaLog = function(p0, p1, p2, p3, p4, callback) {
return dwr.engine._execute(p._path, 'manipulaArquivo', 'gravaLog', arguments);
};
...
p.le2 = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'manipulaArquivo', 'le2', arguments);
};
...
p.renomeiaFoto = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'manipulaArquivo', 'renomeiaFoto', arguments);
};

dwr.engine._setObject("manipulaArquivo", p);
}
})();
