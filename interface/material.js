...
(function() {
if (dwr.engine._getObject("material") == undefined) {
var p;
...
return dwr.engine._execute(p._path, 'material', 'getInstance', arguments);
};
...
p.findByPedacoNome = function(p0, callback) {
return dwr.engine._execute(p._path, 'material', 'findByPedacoNome', arguments);
};
...
return dwr.engine._execute(p._path, 'material', 'setJdbcTemplate', arguments);
};
...
return dwr.engine._execute(p._path, 'material', 'getDataSource', arguments);
};
...
return dwr.engine._execute(p._path, 'material', 'setDataSource', arguments);
};
...
return dwr.engine._execute(p._path, 'material', 'getJdbcTemplate', arguments);
};
...
return dwr.engine._execute(p._path, 'material', 'afterPropertiesSet', arguments);
};

dwr.engine._setObject("material", p);
}
})();
