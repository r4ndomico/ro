function dataLgt(campo){
    ...
    if(dia !="01" && $('Convenio_convenio').value == "Light"){
        return result="Data permitida somente para o primeiro dia do mês.";
    }
    
    if(anoMesDia > anoMesDiaAdm){
        return result="Data de Solicitação superior a data da visita.";
    }
