function carregaCriticasPagaNi(exame){
    
    recuperaCriticasPagaNi();
    return;
    
    function recuperaCriticasPagaNi(){
        ...
        exameDLO.validaExame(exame,data,convenio,unidadeAtendimento,{
    ...
    /*function examePagaNiCB(item){
        ...
        adm.exa.qtdChCv=item[3];
        adm.exa.senCvExa=item[4];
        adm.exa.unidadeRealizacao=item[5];
        adm.exa.posto=item[6];
        adm.exa.exaRecipiente=item[7];
